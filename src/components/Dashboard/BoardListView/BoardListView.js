...
export default function BoardListView({ createNewHandleFunc }) {
  ...
  return (
    <div style={{ width: "100%" }} className="py-4">
      ...
      >
        ...
        <div className="flex items-center">
          <button onClick={()=>{createNewHandleFunc()}} className={styles.createNewButton}>
            <IoIosAdd size={16}/> <span> New </span>
          </button>
