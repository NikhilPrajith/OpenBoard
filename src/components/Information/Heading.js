...
export default function Heading({open, type}) {
  ...
  const {isSavedBoard, saveDataToLocalStorageBoard} = useBoard();
  return (
    <div className={styles.headingContainer}>
        ...
        {type != 'Endless Board' && <>
          ...
          {!isSavedBoard  && <div className={styles.saveNowButton} onClick={saveDataToLocalStorageBoard}>Save Now</div>}
          </>}
